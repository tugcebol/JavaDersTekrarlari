...
public class P05 {
    ...
    public static void main(String[] args) {
        ...
        if (kart == 'E' && adet>10) System.out.println(((adet*fiyat)*0.8) + " $ ödemeniz gerekli.");
        else if (kart == 'E' && adet<=10) System.out.println(((adet*fiyat)*0.85) + " $ ödemeniz gerekli.");
        else if (kart == 'H' && adet>10) System.out.println(((adet*fiyat)*0.85) + " $ ödemeniz gerekli.");
        else if (kart == 'H' && adet<=10) System.out.println(((adet*fiyat)*0.9) + " $ ödemeniz gerekli.");
